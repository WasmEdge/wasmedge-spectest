...
(assert_trap (invoke "drop-R1-as-R2") "used with the wrong type, expected guest-defined resource but found a different guest-defined resource")
(component instance $i $WrongType)
(assert_trap (invoke "return-R1-as-R2") "used with the wrong type, expected guest-defined resource but found a different guest-defined resource")
